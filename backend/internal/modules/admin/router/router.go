...
func RegisterRoutes(
	...
	protected.GET("/diagram-templates", adminHandler.DiagramTemplates)
	protected.POST("/diagram-templates/:id/publish", adminHandler.PublishDiagramTemplate)
	protected.POST("/diagram-templates/:id/unpublish", adminHandler.UnpublishDiagramTemplate)
