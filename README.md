...
- 复习和 AI 已具备 SM-2 调度边界、Deck/Card 与 AI draft 基础闭环；`v1.1` 已开始补 Deck/Card、今日队列、复习回写、AI 草稿/用量/任务 API 合约测试、后端 card handler 边界测试、ReviewWorkspace 页面回归测试和 AI 草稿确认页面测试。
