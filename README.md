...
- 图谱冲突专项回归可直接执行 `npm run verify:graph-conflicts`；当前冲突生命周期、工作区测试映射、图谱工作区 smoke、真实 `graph_version_conflict` 路径和固定入口见 `docs/engineering/GRAPH_CONFLICT_REGRESSION.md`。
