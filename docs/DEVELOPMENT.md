...
- 图谱冲突专项回归入口为 `npm run verify:graph-conflicts`；当前冲突生命周期、工作区测试映射、图谱工作区桌面/窄屏 smoke、真实 `graph_version_conflict` 路径和固定入口集中记录在 `docs/engineering/GRAPH_CONFLICT_REGRESSION.md`。
