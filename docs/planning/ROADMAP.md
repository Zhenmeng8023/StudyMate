...
- 2026-07-15 对照《学伴项目-设计说明书.md》后，v1.1 后续执行改为快速原型优先：先跑通“资料/PDF -> 批注 -> 笔记/图谱 -> 卡片 -> 复习 -> 薄弱反馈”主演示闭环，再补完整 Anki 模型、图谱反馈回写、搜索产品化和后台治理深水区；课程/LMS、桌面端、完整工程图谱、向量/RAG 和 `.apkg` 深兼容继续后置。
